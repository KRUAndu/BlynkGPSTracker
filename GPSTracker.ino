...
// or Software Serial on Uno, Nano (NOT RECOMMENDED, VERY UNSTABLE AND MESSY SERIAL INPUT)
...
// Last update timer display on V8.
WidgetTable securityTable; BLYNK_ATTACH_WIDGET(securityTable, V11); 
